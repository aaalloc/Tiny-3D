                                                                      ...
                                                                      std::filesystem::path filePath)
{
    ...
    {
        std::cout << "Loaded GLTF data: " << filePath << std::endl;
    }
    ...
    else
    {
        ...
        {
            fmt::print("Failed to load glTF: {} \n", fastgltf::to_underlying(err));
            return {};
        }
        gltf = std::move(load.get());
        std::cout << "Loaded GLTF binary: " << filePath << std::endl;
    }
    ...
    fmt::print("Loaded GLTF: {} meshes\n", meshes.size());
    fmt::print("Loaded GLTF: {} vertices\n", vertices.size());
    return meshes;
}
...
std::optional<AllocatedImage> load_image(VulkanEngine *engine, fastgltf::Asset &asset, fastgltf::Image &image)
{
    ...
    std::visit(
        fastgltf::visitor{
            ...
            {
                std::cout << "load_image with URI: " << filePath.uri.c_str() << std::endl;
            ...
            {
                std::cout << "load_image with vector" << std::endl;
            ...
            {
                std::cout << "load_image with buffer view" << std::endl;
                ...
                std::visit(
                    fastgltf::visitor{
                        ...
                        // https://github.com/spnda/fastgltf/blob/9c785634b4ccb9dac46f96f09940b325b628d426/examples/gl_viewer/gl_viewer.cpp#L546
    ...
    for (fastgltf::Node &node : gltf.nodes)
    {
        ...
        std::visit(
            fastgltf::visitor{[&](fastgltf::math::fmat4x4 matrix)
                              { memcpy(&newNode->localTransform, matrix.data(), sizeof(fastgltf::math::fmat4x4)); },
